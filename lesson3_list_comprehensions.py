...
# このプログラムを理解するのに必要な知識
# - リストの内包表記 https://docs.python.jp/3/tutorial/datastructures.html#list-comprehensions
# - タプルとシーケンス https://docs.python.jp/3/tutorial/datastructures.html#tuples-and-sequences
